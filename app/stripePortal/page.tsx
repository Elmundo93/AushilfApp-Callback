...
export default function StripePortalPage() {
  ...
  const handleRedirect = () => {
    const deepLink = 'aushilfapp://(authenticated)/stripePortal'
        ...
        <div className="flex justify-center items-center min-h-screen px-4">
          <Card className="max-w-md w-full border border-amber-300 bg-white/70 backdrop-blur-md shadow-md">
            <CardContent className="p-6 text-center space-y-4">
              <h2 className="text-xl font-semibold text-amber-600">Stripe Portal 🎉</h2>
              ...
              <Button
                ...
                onClick={() => window.open('aushilfapp://(authenticated)/stripePortal')}
              >
                Stripe Portal jetzt öffnen
              </Button>
